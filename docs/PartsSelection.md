...
Reasons: Low drop out version - 65mV @ 1A and 225mV @ 3A. The IC operates over an input voltage range of 2.2V to 6.0V and can provide output voltages between 0.8V and 5V. The output voltage is fixed using an external voltage divider.
